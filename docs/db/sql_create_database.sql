...
JIRA_PROJECT_ID INTEGER( 10 ) AUTO_INCREMENT PRIMARY KEY NOT NULL ,
PROJECT_NAME VARCHAR( 150 ) 
);

CREATE TABLE JIRA_ISSUE (
    JIRA_ISSUE_ID INT(10) AUTO_INCREMENT PRIMARY KEY NOT NULL,
    JIRA_PROJECT_ID INTEGER(10),
    ...
    FOREIGN KEY (JIRA_PROJECT_ID) REFERENCES JIRA_PROJECT(JIRA_PROJECT_ID),
