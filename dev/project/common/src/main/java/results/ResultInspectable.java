...
public interface ResultInspectable
{
	 ...
	 * @param jiraIssueWithPredictedTime jira issue with prediction time to resolve
	 ...
	 * @param jiraIssueWithPredictedTimeToResolves jira issues with prediction times to resolve
